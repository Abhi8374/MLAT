...
class Transformer(nn.Module):
    ...
    def forward(self, enc_inputs, encoded_captions, caption_lengths):
        ...
        encoder_out, encoderlayers_out, enc_self_attns = self.encoder(enc_inputs)# encoder_out: [batch_size, 196, 2048]
        ...
        predictions, encoded_captions, decode_lengths, sort_ind, dec_self_attns, dec_enc_attns = self.decoder(encoderout2, encoded_captions, caption_lengths)
